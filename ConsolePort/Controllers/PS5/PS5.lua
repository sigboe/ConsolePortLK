...
---------------------------------------------------------------
---------------------------------------------------------------
--[[ PS5 Controller template by leoaviana
---------------------------------------------------------------

This template is basically a copy of the PS4 template by Munk, this might need further changes in order to implement possible extra
...
db.Controllers.PS5 = {
	WoWmapper = true,
	Win = 'Use WoWmapperX to play the game with a DualSense controller.\nYou should install and set up WoWmapperX before you continue.',
	Mac = 'You need to use a custom mapping software to play with this controller on a Mac client.',
	LinkWin = 'https://github.com/leoaviana/WoWmapperX/releases/latest',
	LinkMac = 'https://github.com/leoaviana/WoWmapperX?tab=readme-ov-file#non-windows-systems-and-wowmapperx-alternatives',
	Color = {
		['UP'] 			= 	'6882A1',
		['LEFT'] 		= 	'D84E58',
		['RIGHT']		= 	'D35280',
