...
---------------------------------------------------------------
---------------------------------------------------------------
--[[ Switch Controller template by leoaviana
---------------------------------------------------------------
...
db.Controllers.SWITCH = {
	...
	Layout = {
		...
		['CP_X_LEFT2']	= {index = 9, anchor = 'LEFT'},
		-------------------------------------------------
		...
		['CP_X_RIGHT2']	= {index = 9, anchor = 'RIGHT'}, 
		-------------------------------------------------
	},
	Bindings = {
		-- XYAB
		...
		-- Grip buttons (in this case it's being used for the extra two buttons in the middle) 
		['CP_T5'] = {
			[''] 			= 'CP_CAMZOOMOUT', 
		},
		['CP_T6'] = {  
